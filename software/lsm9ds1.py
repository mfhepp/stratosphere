# LSM9DS1 routines taken from
# https://github.com/akimach/LSM9DS1_RaspberryPi_Library
# which is a Raspberry Pi port of
# https://github.com/sparkfun/SparkFun_LSM9DS1_Arduino_Library
# Thanks to SparkFun Electronics for the library
# and Akimasa Kimura for the Raspberry Pi port
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Gyro: %f, %f, %f [deg/s], Accel: %f, %f, %f [Gs], Mag: %f, %f, %f [gauss]" % (cgx, cgy, cgz, cax, cay, caz, cmx, cmy, cmz))
        time.sleep(0.5)
